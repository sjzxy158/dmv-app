...
class FullTileAdFactory(val context: Context) : GoogleMobileAdsPlugin.NativeAdFactory {
    ...
    override fun createNativeAd(
        ...
        with(nativeAdView) {
            ...
            // val headlineView = findViewById<TextView>(R.id.tv_full_tile_native_ad_headline)
            // headlineView.text = nativeAd.headline
            // this.headlineView = headlineView

            // val bodyView = findViewById<TextView>(R.id.tv_full_tile_native_ad_body)
            // with(bodyView) {
            //     text = nativeAd.body
